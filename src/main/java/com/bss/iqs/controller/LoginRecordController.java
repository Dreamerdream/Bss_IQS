...
public class LoginRecordController {
    ...
    @ResponseBody
    //@RequiresPermissions("loginrecord:query")
    public List<LoginRecord> getLoginRecord(@PathVariable String type,@PathVariable String keyword,@PathVariable Integer pageNum,@PathVariable Integer pageSize){
